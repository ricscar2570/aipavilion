 ...
 * Response shape:
 *   {
 *     totalOrders:   number,   // settled paid orders
...
const handler = async (event) => {
    ...
    try {
        ...
        return respond(
            500,
            { error: "INTERNAL_ERROR", message: "Failed to compute stats" },
            event,
        );
    }
};

exports.handler = withObservability("user-stats", handler);
