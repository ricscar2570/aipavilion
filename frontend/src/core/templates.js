...
import { escapeHtml, formatPrice } from "./helpers.js";
                ...
                <div class="flex justify-between items-center h-16">
                    <div class="flex items-center space-x-8">
                        ...
                        <div class="hidden md:flex space-x-6">
                            ...
                            <a href="#/events" class="text-gray-700 hover:text-purple-600 font-medium transition">Events</a>
...
export function homepageHTML() {
    ...
    return `
        <div class="relative overflow-hidden py-20 px-4 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                    <a href="#/events" class="btn-primary text-lg px-8 py-4">Explore Events</a>
                    <a href="#/search" class="px-8 py-4 rounded-xl border border-white/40 text-white">Search Stands</a>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
            ...
            <div id="stands-grid" data-testid="stands-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    return `
        <div class="max-w-2xl mx-auto px-4 py-8">
            ...
            <div class="glass-card rounded-2xl p-6">
                ...
                <button id="pay-btn" data-testid="pay-button" class="btn-primary w-full py-3">
...
export function orderSuccessHTML(order) {
    ...
    return `
        <div class="max-w-2xl mx-auto px-4 py-16 text-center">
            <div class="glass-card rounded-2xl p-8">
                ...
                <h1 class="text-3xl font-bold text-gray-900 mb-3">Payment confirmed</h1>
                <p class="text-gray-600 mb-2">Your order has been recorded successfully.</p>
                <p class="text-sm text-gray-500 mb-6">Order ${escapeHtml(orderId.substring(0, 12))}</p>
                <p class="text-2xl font-bold text-gray-900 mb-8">${formatPrice(total)}</p>
                <div class="flex flex-col sm:flex-row gap-3 justify-center">
                    <a href="#/dashboard" class="btn-primary px-6 py-3">View dashboard</a>
                    <a href="#/" class="px-6 py-3 rounded-xl border border-gray-200 text-gray-700">Continue browsing</a>
                </div>
            </div>
        </div>`;
}
...
export function userMenuHTML() {
    return `
        ...
        <a href="#/organizer" class="block px-4 py-2 text-gray-700 hover:bg-gray-50 hover:text-purple-600 transition">Organizer Portal</a>
        <a href="#/exhibitor" class="block px-4 py-2 text-gray-700 hover:bg-gray-50 hover:text-purple-600 transition">Exhibitor Portal</a>
