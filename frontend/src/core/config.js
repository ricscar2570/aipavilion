...
export const CONFIG = {
    ...
    payments: {
        mode: injected.paymentMode || "disabled",
        enabled: ["stripe", "simulated"].includes(
            injected.paymentMode || "disabled",
        ),
    },

    botProtection: {
        mode: injected.botChallengeMode || "disabled",
        siteKey: injected.turnstileSiteKey || "",
        enabled: ["simulated", "turnstile"].includes(
            injected.botChallengeMode || "disabled",
        ),
    },
    ...
    ar: {
        ...
        modelsCDN: injected.cloudFrontDomain
            ? `https://${injected.cloudFrontDomain}/models/`
            : "",
    },

    tours: {
        enabled: injected.feature360Tours || false,
        imagesCDN: injected.cloudFrontDomain
            ? `https://${injected.cloudFrontDomain}/360/`
            : "",
    },
